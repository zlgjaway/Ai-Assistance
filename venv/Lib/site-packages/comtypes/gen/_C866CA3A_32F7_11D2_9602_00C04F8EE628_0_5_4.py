...
__all__ = [
    'DISPID_SPPChildren', 'DISPID_SRCEHypothesis', 'SVSFParseSapi',
    'DISPID_SGRSTsCount', 'SpeechTokenIdUserLexicon', 'SPWORDLIST',
    'SSFMOpenForRead', 'SpeechGrammarTagUnlimitedDictation',
    'SPEI_SOUND_END', 'SRADynamic', 'DISPID_SPARecoResult',
    'SGDSActive', 'DISPID_SPRulesItem', 'DISPID_SpeechVoice',
    'ISpeechPhraseInfo', 'DISPID_SPIStartTime',
    'ISpeechXMLRecoResult', 'DISPID_SRRSpeakAudio', 'SRTStandard',
    'SAFTGSM610_22kHzMono', 'DISPID_SPELexicalForm', 'SASClosed',
    'SGPronounciation', 'DISPID_SVEAudioLevel',
    'DISPID_SOTRemoveStorageFileName', 'SpeechCategoryAppLexicons',
    'SPEI_SR_PRIVATE', 'SPRST_INACTIVE_WITH_PURGE',
    'SDTPronunciation', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SAFType', 'DISPID_SRSClsidEngine', 'SDTRule',
    'SWTDeleted', 'SPAO_NONE', 'SPPS_Noncontent', 'SPAS_RUN',
    'tagSPPROPERTYINFO', 'SPPHRASERULE', 'ISpeechPhraseAlternate',
    'DISPID_SPEsItem', 'eWORDTYPE_DELETED', 'ISpAudio',
    'SAFT16kHz8BitMono', 'STCInprocHandler', 'SSFMOpenReadWrite',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SGRSAddRuleTransition',
    'SPWT_PRONUNCIATION', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_RESERVED7', 'SpWaveFormatEx', 'SP_VISEME_1',
    'SVSFVoiceMask', 'SDTProperty', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SOTCId', 'SpeechAudioProperties', 'SASStop',
    '_ISpeechVoiceEvents', 'DISPID_SABufferInfo',
    'SpUnCompressedLexicon', 'DISPID_SFSClose',
    'DISPID_SABIBufferSize', 'SAFT8kHz16BitStereo',
    'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechLexiconPronunciation', 'SBONone', 'SPEI_RESERVED3',
    'SpeechRegistryLocalMachineRoot', 'SPPHRASEELEMENT',
    'DISPID_SRGCmdLoadFromObject', 'ISpStream',
    'DISPID_SRCEPropertyNumberChange', 'SPVPRI_ALERT', 'SRAImport',
    'SVSFDefault', 'SPSHT_Unknown', 'DISPID_SRCState',
    'DISPID_SpeechAudio', 'SPRS_ACTIVE', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE2', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPACommit', 'ISpeechDataKey',
    'DISPID_SLGetPronunciations', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechXMLRecoResult', 'SP_VISEME_5', 'SpeechTokenKeyUI',
    'DISPID_SPEDisplayText', 'DISPID_SRCreateRecoContext',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_PRIVATE17', 'SREStreamEnd',
    'DISPID_SPIProperties', 'SpeechTokenShellFolder',
    'DISPID_SPRulesCount', 'SPWT_LEXICAL', 'SRTExtendableParse',
    'DISPID_SGRAttributes', 'SRERecognition',
    'DISPID_SRCEInterference', 'DISPID_SLWsCount', 'SPSInterjection',
    'DISPID_SMSSetData', 'ISpResourceManager',
    'DISPID_SDKSetBinaryValue', 'SWPKnownWordPronounceable',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPEPronunciation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPSHT_NotOverriden',
    'ISpeechMMSysAudio', 'SAFT44kHz16BitStereo', 'SpeechAudioState',
    ...
    'SVSFPersistXML', 'SECNormalConfidence', 'SpeechVoiceEvents',
    'SAFT11kHz16BitMono', 'ISpeechLexicon', 'DISPID_SVSpeak',
    'LONG_PTR', 'SPPHRASE', 'ISpRecoResult',
    'DISPID_SRCEEnginePrivate', 'SAFTNoAssignedFormat',
    'DISPID_SVSyncronousSpeakTimeout',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVGetVoices',
    'SPPHRASEPROPERTY', 'DISPID_SRCRetainedAudio',
    'SpeechVoiceCategoryTTSRate', 'SRSActiveAlways', 'SPFILEMODE',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechGrammarRuleState', 'SPLEXICONTYPE',
    'STSF_LocalAppData', 'ISpRecoGrammar', 'DISPID_SGRsDynamic',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPIGetDisplayAttributes',
    'SRSEIsSpeaking', 'DISPID_SpeechRecoResult2',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPAsItem', 'SpeechGrammarTagDictation',
    'SpeechTokenKeyFiles', 'SAFT22kHz16BitStereo',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechPhraseReplacements',
    'SPRST_ACTIVE_ALWAYS', 'SPEI_HYPOTHESIS', 'SPEI_MAX_TTS',
    'SP_VISEME_10', 'SPEI_PHRASE_START',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPSSuppressWord',
    'SVEWordBoundary', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechAudioStatus', 'DISPID_SRAudioInputStream',
    'SRATopLevel', 'DISPID_SWFEChannels', 'DISPID_SRRTTickCount',
    'SP_VISEME_15', 'DISPID_SVDisplayUI', 'DISPID_SPRsItem',
    ...
    'SpeechRecoContextState', 'DISPID_SGRSTsItem',
    'ISpGrammarBuilder', 'DISPID_SRGDictationUnload',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechRecoContext', 'eLEXTYPE_PRIVATE12',
    'SPINTERFERENCE_NOSIGNAL', 'eLEXTYPE_RESERVED6',
    'SpSharedRecognizer', 'DISPID_SRRPhraseInfo', 'SPAUDIOSTATUS',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechAudioFormat', 'SASPause',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCCmdMaxAlternates',
    'UINT_PTR', 'DISPID_SLPType', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPRsCount', 'SPSEMANTICFORMAT', 'SPBINARYGRAMMAR',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_7',
    'SPEI_RECO_OTHER_CONTEXT', 'SPWAVEFORMATTYPE',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEAdaptation',
    'DISPID_SGRsCommit', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRuleParent', 'SVP_11',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_SENTENCE_BOUNDARY',
    'SPPS_Verb', 'ISpRecoCategory', 'SSTTDictation', 'ISpEventSource',
    'SPWORDTYPE', 'DISPID_SRGCmdSetRuleIdState', 'SPCS_ENABLED',
    'SPWF_INPUT', 'ISpeechAudio', 'SPAR_Medium',
    'DISPID_SpeechCustomStream', 'SRESoundStart',
    'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE15', 'DISPID_SRRTimes',
    'DISPID_SDKDeleteValue', 'SAFTADPCM_22kHzStereo',
    'SECFIgnoreWidth', 'DISPIDSPTSI_ActiveLength', 'SPVPRI_OVER',
    'eLEXTYPE_PRIVATE3', 'SAFT44kHz8BitMono', 'DISPID_SRGRecoContext',
    'DISPID_SPIElements', 'SPEI_MIN_SR', 'DISPID_SPIGrammarId',
    'SECFDefault', 'SPRS_INACTIVE', 'DISPID_SpeechPhraseBuilder',
    'SAFT24kHz8BitMono', 'SRERecoOtherContext',
    'DISPID_SASNonBlockingIO', 'DISPID_SLPPartOfSpeech',
    'SPCT_SUB_DICTATION', 'DISPID_SVWaitUntilDone', 'SVEVoiceChange',
    'SLTUser', 'DISPID_SRSNumberOfActiveRules', 'ISpNotifySource',
    'SDTLexicalForm', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechGrammarRules', 'Speech_StreamPos_Asap',
    'SPEI_MAX_SR', '_RemotableHandle', 'SECFNoSpecialChars',
    'SITooSlow', 'SpeechInterference', 'SpeechGrammarWordType',
    'DISPID_SOTCDefault', 'SVPAlert', 'DISPID_SLGetGenerationChange',
    'SAFTADPCM_22kHzMono', 'ISpeechObjectTokenCategory',
    'ISpeechMemoryStream', 'DISPID_SRRAudioFormat', 'DISPID_SRStatus',
    'DISPID_SVEWord', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRCRecognizer', 'DISPID_SRCBookmark',
    'DISPID_SRRTStreamTime', 'SVP_1', 'DISPID_SGRSTPropertyId',
    'DISPID_SRCESoundStart', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SOTCSetId', 'SREStateChange',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SWFESamplesPerSec',
    'SGSEnabled', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPLO_STATIC',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRCERequestUI',
    'SPLOADOPTIONS', 'SpPhoneticAlphabetConverter',
    'SpeechBookmarkOptions', 'ISpeechWaveFormatEx',
    'DISPID_SpeechPhoneConverter', 'STSF_CommonAppData',
    'DISPID_SRGId', 'DISPID_SOTDataKey', 'SpStreamFormatConverter',
    'STSF_AppData', 'SP_VISEME_3', 'SVSFUnusedFlags',
    'SpeechRunState', 'DISPID_SpeechGrammarRule',
    'SAFT16kHz16BitStereo', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_VISEME', 'SpeechAudioFormatGUIDWave', 'SAFT8kHz8BitStereo',
    'DISPID_SPPs_NewEnum', 'SpeechCategoryRecoProfiles',
    'DISPID_SRCERecognition', 'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_0',
    'DISPID_SpeechObjectToken', 'STCRemoteServer', 'SPVISEMES',
    'DISPID_SAVolume', 'DISPID_SRCCreateGrammar',
    'DISPID_SRIsUISupported', 'DISPID_SVEPhoneme', 'SVEAllEvents',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRProfile', 'SPADAPTATIONRELEVANCE',
    'SAFTGSM610_11kHzMono', 'SPGS_DISABLED',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVEBookmark',
    'DISPID_SPRuleNumberOfElements', 'SpCustomStream', 'SP_VISEME_9',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKEnumKeys',
    'SVP_8', 'SPEI_WORD_BOUNDARY', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRRGetXMLResult', 'DISPID_SVAudioOutput',
    'SPAO_RETAIN_AUDIO', 'SAFTGSM610_44kHzMono', 'DISPID_SPPValue',
    '_SPAUDIOSTATE', 'SRAInterpreter', 'SPAS_CLOSED',
    'SVEEndInputStream', 'DISPID_SABIMinNotification',
    'SPBOOKMARKOPTIONS', 'ISpSerializeState', 'SpeechStreamFileMode',
    'DISPID_SLWsItem', 'eLEXTYPE_PRIVATE5', 'DISPID_SMSADeviceId',
    'DISPID_SPIEnginePrivateData', 'SPEI_END_SR_STREAM',
    'DISPID_SOTCreateInstance', 'SP_VISEME_19', 'SVP_21', 'SVSFIsXML',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCERecognitionForOtherContext',
    'SPEI_RESERVED5', 'SINone', 'SRTAutopause',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPPsCount', 'SRTEmulated',
    'SPBO_AHEAD', 'SP_VISEME_14', 'SVPOver', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPRs_NewEnum', 'SAFTADPCM_11kHzMono', 'DISPID_SPPId',
    'DISPID_SVPause', 'SPRECOGNIZERSTATUS', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SWFEBlockAlign', 'SP_VISEME_21',
    'DISPID_SASCurrentSeekPosition', 'Speech_StreamPos_RealTime',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPIAudioStreamPosition',
    'SAFTADPCM_11kHzStereo', 'STCAll', 'SDKLCurrentConfig',
    'SP_VISEME_2', 'ISpeechLexiconPronunciations',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPPConfidence',
    'SPGS_ENABLED', 'SpInprocRecognizer',
    'DISPID_SPRNumberOfElements', 'SAFT22kHz8BitMono', 'SPEI_MIN_TTS',
    'DISPID_SOTId', 'ISpProperties', 'SpFileStream',
    'SPDKL_CurrentUser', 'SPGRAMMARWORDTYPE', 'SpVoice',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLPSymbolic', 'SVP_0',
    'DISPID_SLPPhoneIds', 'ISpDataKey', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SGRsAdd', 'SREBookmark', 'DISPID_SRRAlternates',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPARTOFSPEECH', 'SRTSMLTimeout',
    'SPAR_Unknown', 'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVSkip', 'SVP_5', 'SPPS_LMA', 'SPSNoun',
    'eWORDTYPE_ADDED', 'SPSHT_EMAIL', 'ISpeechAudioBufferInfo',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE8', 'DISPID_SGRName',
    'SPGS_EXCLUSIVE', 'DISPID_SOTRemove', 'DISPID_SVVoice',
    'IInternetSecurityMgrSite',
    'SpeechPropertyHighConfidenceThreshold', 'SPDATAKEYLOCATION',
    'DISPID_SDKGetlongValue', 'SpInProcRecoContext',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPRuleId',
    'SpeechRecoProfileProperties', 'SpeechPartOfSpeech',
    'SFTSREngine', 'SP_VISEME_20', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRTLength', 'SpeechPropertyAdaptationOn',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPPFirstElement', 'SITooLoud',
    'DISPID_SPRFirstElement', 'SPSERIALIZEDPHRASE', 'SPWF_SRENGINE',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechPhraseRules', 'DISPID_SPEsCount',
    'DISPID_SPPParent', 'SDTDisplayText', 'SpeechWordType',
    'SPWORDPRONOUNCEABLE', 'SpStream', 'ISpStreamFormat',
    'SPEI_VOICE_CHANGE', 'SPEVENTENUM', 'SPAS_STOP', 'SPEI_RESERVED1',
    'SPBO_NONE', 'DISPID_SRCCreateResultFromMemory',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTSetId', 'DISPID_SDKDeleteKey',
    'DISPID_SPIAudioSizeBytes', 'SITooQuiet', 'ISpRecoContext2',
    'SVEPhoneme', 'SpeechTokenValueCLSID',
    'SWPUnknownWordPronounceable', 'SPCS_DISABLED', 'SREPrivate',
    'DISPID_SpeechMMSysAudio', 'SpeechDataKeyLocation',
    'SPVOICESTATUS', 'ISpeechLexiconWords',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpeechPropertyResponseSpeed',
    'SECLowConfidence', 'SpeechAudioVolume', 'Speech_Max_Word_Length',
    'SREPropertyStringChange', 'eLEXTYPE_PRIVATE16', 'SPSHORTCUTTYPE',
    'SPPHRASEREPLACEMENT', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechRecoResultDispatch', 'SPCT_SLEEP', 'DISPID_SGRSTRule',
    'SAFT24kHz8BitStereo', 'DISPID_SOTCGetDataKey',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPPS_RESERVED3',
    'SECFEmulateResult', 'DISPID_SVStatus', 'ISpeechAudioFormat',
    'DISPID_SRGetRecognizers', 'DISPID_SRAudioInput', 'SPSMF_UPS',
    'SGRSTTTextBuffer', 'SpMMAudioEnum', 'SVP_15', 'SVP_19',
    'Speech_Max_Pron_Length', 'DISPID_SpeechPhraseAlternate',
    'SPEI_SOUND_START', 'SAFT12kHz8BitMono', 'SRAExport',
    'SPWORDPRONUNCIATION', 'SpTextSelectionInformation',
    'SVF_Stressed', 'SAFT44kHz16BitMono', 'SAFTText',
    'SPWORDPRONUNCIATIONLIST', 'SVSFlagsAsync', 'SpeechLoadOption',
    'ISpeechRecoResult', 'ISpeechObjectToken', 'SAFT48kHz16BitStereo',
    'SVP_17', 'SPEI_RECO_STATE_CHANGE', 'SREPhraseStart',
    'DISPID_SpeechLexicon', 'SPLO_DYNAMIC',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRsCount',
    'SDA_Two_Trailing_Spaces', 'SPSEMANTICERRORINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'STCInprocServer',
    'ISpLexicon', 'SpeechCategoryAudioIn', 'SVSFIsFilename',
    'DISPID_SOTCEnumerateTokens', 'SAFT11kHz8BitStereo',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVAudioOutputStream',
    'DISPID_SpeechRecoResult', 'DISPID_SWFEExtraData',
    'DISPID_SAStatus', 'DISPID_SLWPronunciations',
    'DISPID_SGRSTWeight', 'ISpRecognizer2', 'SVP_7',
    'DISPID_SRCEFalseRecognition', 'SFTInput',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFT11kHz16BitStereo',
    'eLEXTYPE_PRIVATE4', 'SPSHORTCUTPAIR', 'ISpeechPhraseElement',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SGRId', 'SpMMAudioIn',
    'SPEI_REQUEST_UI', 'ISpPhraseAlt', 'SRESoundEnd',
    'eLEXTYPE_PRIVATE19', 'SVSFParseSsml',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechRecognizer',
    'SRAONone', 'SLOStatic', 'DISPID_SRGetFormat',
    'SAFT12kHz16BitMono', 'SINoise', 'IEnumString', 'DISPID_SBSSeek',
    'DISPID_SOTGetAttribute', 'ISpeechPhraseReplacement', 'ISpVoice',
    'SREAllEvents', 'DISPID_SWFEFormatTag', 'SECHighConfidence',
    'ISpShortcut', 'DISPID_SFSOpen', 'DISPID_SpeechLexiconProns',
    'SPDKL_LocalMachine', 'DISPID_SVEStreamEnd',
    'eLEXTYPE_RESERVED10', 'SpeechVoiceSkipTypeSentence',
    'SGRSTTWord', 'SVP_12', 'SAFT24kHz16BitStereo',
    'ISpeechGrammarRuleStateTransition', 'SpPhraseInfoBuilder',
    'SREAdaptation', 'DISPID_SpeechFileStream', 'SREAudioLevel',
    'ISpRecoContext', 'SpeechEmulationCompareFlags', 'SSTTWildcard',
    'DISPID_SMSAMMHandle', 'SRSInactiveWithPurge',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SASState',
    'DISPIDSPTSI_SelectionLength', 'SGDSActiveUserDelimited',
    'SPGRAMMARSTATE', 'SGSExclusive', 'SAFTExtendedAudioFormat',
    'SpAudioFormat', 'DISPID_SPEDisplayAttributes',
    'SPPS_NotOverriden', 'DISPID_SRRRecoContext',
    ...
    'SPDKL_CurrentConfig', 'SAFTNonStandardFormat',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechVisemeType', 'SPCT_COMMAND',
    'ISpeechGrammarRules', 'DISPID_SGRsItem', 'DISPID_SRCEAudioLevel',
    'DISPID_SAEventHandle', 'SpeechStreamSeekPositionType',
    'SpeechPropertyResourceUsage', 'DISPID_SRGState',
    'SAFTGSM610_8kHzMono', 'DISPID_SGRsFindRule', 'SPPS_Function',
    'DISPID_SDKOpenKey', 'DISPID_SRGReset',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVSVisemeId', 'SpeechCategoryPhoneConverters',
    'DISPID_SRRSaveToMemory', 'DISPID_SPIGetText',
    'eLEXTYPE_PRIVATE6', 'SSTTTextBuffer', 'SVSFPurgeBeforeSpeak',
    'SpeechAudioFormatType', 'DISPID_SGRSTText',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechEngineProperties',
    'SP_VISEME_17', 'eLEXTYPE_RESERVED9', 'DISPID_SVGetProfiles',
    'ISpeechRecoResultTimes', 'SPVPRIORITY', 'SpeechRegistryUserRoot',
    'DISPID_SpeechLexiconWords', 'DISPID_SRRecognizer',
    'DISPID_SVSInputSentencePosition', 'DISPID_SBSWrite',
    'DISPID_SDKGetBinaryValue', 'SPXRO_SML', 'ISpeechAudioStatus',
    'SpeechRecognizerState', 'DISPID_SpeechRecoResultTimes',
    'SP_VISEME_8', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRDisplayUI', 'DISPID_SRGDictationLoad',
    'SPCT_SUB_COMMAND', 'SP_VISEME_12', 'SpeechWordPronounceable',
    'ISpeechVoiceStatus', 'eLEXTYPE_PRIVATE10',
    'SAFTADPCM_44kHzStereo', 'SLTApp', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpXMLRecoResult', 'DISPID_SpeechMemoryStream',
    'DISPID_SLWs_NewEnum', 'SpNotifyTranslator', 'SpeechMicTraining',
    'DISPID_SGRs_NewEnum', 'ISpeechPhraseProperties',
    'SAFT32kHz16BitMono', 'DISPID_SPIAudioSizeTime',
    'SGDSActiveWithAutoPause', 'DISPID_SDKCreateKey', 'SRCS_Enabled',
    'SpeechCategoryAudioOut', 'DISPID_SVEEnginePrivate',
    'SP_VISEME_6', 'SPBO_TIME_UNITS', 'SpeechFormatType',
    'DISPID_SVSInputWordLength', 'DISPID_SMSALineId',
    'DISPID_SLRemovePronunciation', 'DISPID_SVEventInterests',
    'SPPS_RESERVED1', 'SAFT8kHz8BitMono', 'SPFM_OPEN_READONLY',
    'SPSFunction', 'SDA_One_Trailing_Space', 'SPEI_TTS_BOOKMARK',
    'ISpeechObjectTokens', 'SDA_Consume_Leading_Spaces',
    'SDKLCurrentUser', 'SVF_Emphasis', 'SpeechRuleAttributes',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPEAudioSizeTime',
    'eLEXTYPE_USER', 'SpeechDictationTopicSpelling',
    'SAFT8kHz16BitMono', 'DISPID_SVSLastBookmark', 'SBOPause',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SASetState', 'SVP_4', 'SVP_20', 'SPINTERFERENCE_TOOLOUD',
    'SGRSTTEpsilon', 'DISPID_SPRText', 'SpeechAudioFormatGUIDText',
    'SASRun', 'DISPID_SOTDisplayUI', 'DISPID_SRCEventInterests',
    'SREInterference', 'SpeechLexiconType', 'SPPS_SuppressWord',
    'SAFTADPCM_44kHzMono', 'SpeechGrammarTagWildcard', 'SSFMCreate',
    'DISPID_SRCEEndStream', 'SAFT11kHz8BitMono', 'SDTAll',
    'DISPID_SLGenerationId', 'DISPID_SVPriority', 'WAVEFORMATEX',
    'ISpeechPhraseProperty', 'SPEI_RECOGNITION',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechLexiconPronunciation',
    'SGLexical', 'DISPID_SRGDictationSetState', 'SGDisplay',
    'SECFIgnoreCase', 'SpResourceManager', 'SVEStartInputStream',
    'SAFTDefault', 'SREFalseRecognition', 'SPEI_SR_BOOKMARK',
    'ISpeechResourceLoader', 'DISPID_SLWWord',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechCustomStream',
    'DISPID_SRCEPhraseStart', 'SVP_13', 'ISpPhrase', 'SpLexicon',
    '__MIDL_IWinTypes_0009', 'SPINTERFERENCE_TOOSLOW',
    'SPRST_INACTIVE', 'ISpeechRecognizerStatus', 'ISpeechLexiconWord',
    'SPEI_ADAPTATION', 'SpeechRecognitionType',
    'SpeechTokenKeyAttributes', 'SPPS_RESERVED4', 'SP_VISEME_4',
    'DISPID_SPERequiredConfidence', 'SAFTCCITT_ALaw_22kHzStereo',
    'tagSTATSTG', 'IInternetSecurityManager',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'eLEXTYPE_APP',
    'DISPID_SRRTOffsetFromStart', 'DISPIDSPRG',
    'DISPID_SPRuleEngineConfidence', 'SPFM_CREATE',
    'IEnumSpObjectTokens', 'DISPID_SLWType',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCResume', 'SPAUDIOOPTIONS',
    'SAFT32kHz8BitStereo', 'SPEI_UNDEFINED',
    'DISPID_SDKGetStringValue', 'SREHypothesis',
    'DISPID_SREmulateRecognition', 'SVP_2', 'SpeechTokenContext',
    'SPEI_PHONEME', 'SPINTERFERENCE_NONE', 'SDTAudio', 'SPRST_ACTIVE',
    'eLEXTYPE_PRIVATE18', 'SGRSTTDictation', 'SVP_9', 'SLODynamic',
    'SAFTCCITT_ALaw_8kHzMono', 'IStream', 'SPEI_RESERVED2', 'SVP_3',
    'SPSVerb', 'SVPNormal', 'SPCT_DICTATION', 'SPAR_Low',
    'DISPID_SPRuleConfidence', 'DISPID_SRState', 'DISPID_SPPName',
    'SVP_14', 'SPAS_PAUSE', 'SPVPRI_NORMAL', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPEAudioStreamOffset', 'SpObjectTokenCategory',
    'SITooFast', 'DISPID_SDKSetStringValue', 'DISPID_SPRules_NewEnum',
    'SPRULE', 'SGSDisabled', 'SPSUnknown', 'SpeechDisplayAttributes',
    'DISPID_SVSLastResult', 'SpShortcut', 'ISpeechFileStream',
    'STSF_FlagCreate', 'eLEXTYPE_PRIVATE9', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRRSetTextFeedback',
    'SPEI_INTERFERENCE', 'SAFTADPCM_8kHzMono',
    'DISPID_SPEAudioTimeOffset', 'SPPS_Modifier',
    'SAFT16kHz8BitStereo', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSTType', 'DISPID_SPPEngineConfidence',
    'DISPID_SLAddPronunciation', 'DISPID_SOTIsUISupported',
    'SpeechRuleState', 'SVESentenceBoundary',
    'DISPID_SRCRetainedAudioFormat', 'SpeechDiscardType',
    'DISPID_SLGetWords', 'SAFT12kHz16BitStereo',
    'DISPID_SVESentenceBoundary', 'SECFIgnoreKanaType',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechPhraseProperties',
    'STCLocalServer', 'DISPID_SpeechBaseStream', 'DISPID_SVVolume',
    'DISPID_SGRInitialState', 'DISPID_SPPNumberOfElements',
    'DISPID_SVSpeakStream', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SGRSTPropertyValue', 'DISPIDSPTSI_ActiveOffset',
    'SDTReplacement', 'SpeechUserTraining', 'DISPID_SDKEnumValues',
    'SGRSTTRule', 'SpeechEngineConfidence', 'SPAUDIOBUFFERINFO',
    'DISPID_SPILanguageId', 'DISPID_SADefaultFormat',
    'ISpeechPhoneConverter',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT22kHz8BitStereo',
    'DISPID_SRCVoicePurgeEvent', 'SVEViseme', 'SP_VISEME_16',
    'DISPID_SpeechDataKey', 'SSFMCreateForWrite', 'SVSFNLPMask',
    'SpeechSpecialTransitionType', 'DISPID_SRSAudioStatus',
    'SRSInactive', 'SRTReSent', 'DISPID_SWFEBitsPerSample',
    'SpObjectToken', 'SVEAudioLevel', 'ISpMMSysAudio',
    'DISPID_SPIReplacements', 'DISPID_SLPsCount',
    'DISPID_SLPs_NewEnum', 'SpMMAudioOut',
    'DISPID_SPAStartElementInResult', 'SpeechRecoEvents',
    'DISPID_SPEEngineConfidence', 'SVF_None', 'ISpeechPhraseElements',
    'SDKLLocalMachine', 'DISPID_SRCEBookmark',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SAFGuid', 'SVSFParseAutodetect',
    'ISpeechPhraseRules', 'SAFT44kHz8BitStereo', 'SPPS_RESERVED2',
    'DISPID_SGRAddState', 'SPRST_NUM_STATES',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVSInputWordPosition', 'DISPIDSPTSI',
    'DISPID_SABIEventBias', 'DISPID_SVSRunningState',
    'SpeechRetainedAudioOptions', 'SpeechVisemeFeature',
    'DISPID_SGRSTs_NewEnum', 'SPTEXTSELECTIONINFO',
    'SPEVENTSOURCEINFO', 'SPSHT_OTHER', 'SGDSInactive',
    'SPFM_NUM_MODES', 'DISPID_SVGetAudioInputs', 'ISequentialStream',
    'SVSFNLPSpeakPunc', 'DISPID_SRGCmdLoadFromMemory',
    'SSSPTRelativeToEnd', 'DISPID_SpeechPhraseElement',
    'ISpeechPhraseRule', 'SPCONTEXTSTATE', 'DISPID_SRCVoice',
    'DISPID_SPCLangId', 'SP_VISEME_18', 'SpeechAddRemoveWord',
    'DISPID_SRGSetTextSelection', 'SP_VISEME_13', 'DISPID_SRCPause',
    'DISPID_SpeechPhraseRule', 'ISpNotifyTranslator', 'SPAR_High',
    'DISPID_SpeechRecoContext', 'SPSLMA',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRSCurrentStreamNumber', 'SVP_18',
    'ISpeechTextSelectionInformation', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVSLastBookmarkId', 'SPSNotOverriden',
    'SAFT32kHz8BitMono', 'DISPID_SOTGetDescription',
    'SAFT12kHz8BitStereo', 'SPRULESTATE', 'DISPID_SBSFormat',
    'ISpRecoGrammar2', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SLWLangId', 'SPINTERFERENCE_TOOQUIET',
    'SAFTCCITT_uLaw_44kHzMono', 'SVEPrivate', 'SPINTERFERENCE',
    'ISpRecognizer3', 'SAFT48kHz8BitMono', 'SPAUDIOSTATE',
    'DISPID_SPEs_NewEnum', 'SPPS_Interjection', 'SpeechGrammarState',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRSTransitions',
    'eLEXTYPE_PRIVATE7', 'SpeechVoiceSpeakFlags',
    'SpeechVoicePriority', 'SPINTERFERENCE_NOISE',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRSRule',
    'DISPID_SPRuleName', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRAddResource', 'SAFT32kHz16BitStereo', 'SVEBookmark',
    'DISPID_SGRSAddSpecialTransition', 'ISpObjectTokenCategory',
    'DISPID_SPAsCount', 'SpNullPhoneConverter',
    'DISPID_SpeechObjectTokens', 'SPRECORESULTTIMES',
    'DISPID_SRGCmdLoadFromFile', 'SVP_6', 'SpeechCategoryRecognizers',
    'DISPID_SDKSetLongValue', 'SPWT_DISPLAY',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechVoice', 'DISPID_SBSRead',
    'SPPS_Noun', 'DISPID_SRRAudio', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPCIdToPhone', 'DISPID_SOTMatchesAttributes', 'SRSActive',
    'SINoSignal', 'DISPID_SpeechVoiceEvent', 'SpSharedRecoContext',
    'DISPID_SLPLangId', 'DISPID_SVEStreamStart', 'SVSFParseMask',
    'SRERequestUI', 'ISpeechBaseStream', 'ISpeechRecognizer',
    'SWTAdded', 'ISpEventSink', 'SPEI_TTS_PRIVATE', 'SRARoot',
    'SVSFIsNotXML', 'DISPID_SPPsItem', 'SPBO_PAUSE', 'SpMemoryStream',
    ...
    'DISPID_SABufferNotifySize', 'DISPID_SMSGetData',
    'DISPID_SOTCategory', 'SpeechAllElements',
    'DISPID_SRCEStartStream', 'DISPID_SpeechPhraseAlternates',
    'SRCS_Disabled', 'SP_VISEME_11', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPIEngineId',
    'SPSTREAMFORMATTYPE', 'SRSEDone',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPDKL_DefaultLocation',
    'DISPID_SRGIsPronounceable', 'DISPID_SCSBaseStream',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_END_INPUT_STREAM',
    'SPXMLRESULTOPTIONS', 'SGLexicalNoSpecialChars',
    'SPSERIALIZEDRESULT', 'DISPID_SRCESoundEnd', 'SREStreamStart',
    'SRADefaultToActive', 'SAFT16kHz16BitMono', 'ISpeechRecoGrammar',
    'SGRSTTWildcard', 'SPXRO_Alternates_SML', 'SSSPTRelativeToStart',
    'DISPID_SRSCurrentStreamPosition', 'Speech_Default_Weight',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SGRSTNextState',
    'SPPS_Unknown', 'DISPID_SOTsItem', 'DISPID_SRIsShared',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPPROPERTYINFO',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRGCommit',
    'SPCATEGORYTYPE', 'ISpeechRecoResult2', 'SDKLDefaultLocation',
    'ISpeechPhraseAlternates', 'ISpNotifySink', 'DISPID_SLPsItem',
    'eLEXTYPE_RESERVED4', 'SRAORetainAudio', 'SPEI_RESERVED6',
    'DISPID_SRGRules', 'eLEXTYPE_RESERVED8', 'SPRECOSTATE',
    'DISPID_SVSPhonemeId', 'SpCompressedLexicon', 'DISPID_SVRate',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT22kHz16BitMono',
    'SAFT24kHz16BitMono', 'SDTAlternates', 'SPWORD',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpStreamFormatConverter', 'ISpRecognizer', 'DISPID_SVEViseme',
    'ISpPhoneticAlphabetSelection', 'SREPropertyNumChange',
    'DISPID_SRCERecognizerStateChange', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPCPhoneToId', 'DISPID_SOTsCount', 'ISpeechGrammarRule',
    'eLEXTYPE_PRIVATE11', 'SPSModifier',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SGRClear', 'SPEVENT',
    'SVP_10', 'DISPID_SPAs_NewEnum', 'SAFT48kHz8BitStereo'
]

_check_version('1.1.14', 1657361453.163702)
